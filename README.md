...
- Choose:
  - Windows 10/11 image  
  - Standard size (default is fine)  
- Set username and password  
- Review + Create → Launch VM  
<p align="center">
...
- Copy the VM’s **public IP address** from Azure  
- Open Remote Desktop on your computer  
- Enter IP address and login credentials  
- Connect to the VM  
<p align="center">
...
- Install:
  - PHP Manager  
  - Rewrite Module  
- Use installation files provided with osTicket  
<p align="center">
...
- Create folder: `C:\PHP`  
- Extract PHP files into this folder  
- This allows IIS to run PHP applications 
<p align="center">
...
- Select the PHP executable from `C:\PHP` 
<p align="center">
...
- Move osTicket files to:  
  `C:\inetpub\wwwroot`  
- Rename **upload** folder → **osTicket** 
<p align="center">
...
- Update file permissions (disable inheritance + allow access) 
<p align="center">
...
- Open browser → `http://localhost/osTicket`  
